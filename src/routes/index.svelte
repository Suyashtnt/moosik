	...
	{:then value}
		...
		<div class="bg-white shadow rounded content-center items-center">
			...
			<button
				...
				class="bg-blue-600 hover:bg-gray-100 text-gray-800 font-semibold py-2
...
{:else}
	<div class="centered">
		<form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
			...
			<button
				on:click={itsClicked}
				class="inline-block align-baseline font-bold text-sm hover:text-md
					text-blue-500 hover:text-blue-800 mx-auto">
				Get song
			</button>
		</form>
	</div>
